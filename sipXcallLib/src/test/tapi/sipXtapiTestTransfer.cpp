...
void sipXtapiTestSuite::testBlindTransferSuccess() 
{
    ...
    for (int iStressFactor = 0; iStressFactor<STRESS_FACTOR; iStressFactor++)
    {
        ...
        CPPUNIT_ASSERT(bRC) ;
        // BUG:: Why is line 0????
        bRC = validatorTransferee.waitForCallEvent(0, g_hAutoAnswerCallbackCallOther, CALLSTATE_NEWCALL, CALLSTATE_NEW_CALL_TRANSFER) ;
        CPPUNIT_ASSERT(bRC) ;
        bRC = validatorTransferee.waitForCallEvent(0, g_hAutoAnswerCallbackCallOther, CALLSTATE_REMOTE_OFFERING, CALLSTATE_REMOTE_OFFERING_NORMAL) ;
        CPPUNIT_ASSERT(bRC) ;
        bRC = validatorTransferee.waitForCallEvent(0, g_hAutoAnswerCallbackCallOther, CALLSTATE_REMOTE_ALERTING, CALLSTATE_REMOTE_ALERTING_NORMAL) ;
        CPPUNIT_ASSERT(bRC) ;
        bRC = validatorTransferee.waitForCallEvent(0, g_hAutoAnswerCallbackCallOther, CALLSTATE_CONNECTED, CALLSTATE_CONNECTED_ACTIVE) ;
        CPPUNIT_ASSERT(bRC) ;
        bRC = validatorTransferee.waitForCallEvent(0, g_hAutoAnswerCallbackCallOther, CALLSTATE_AUDIO_EVENT, CALLSTATE_AUDIO_START) ;
        CPPUNIT_ASSERT(bRC) ;
        ...
        bRC = validatorTransferee.waitForCallEvent(0, g_hAutoAnswerCallbackCallOther, CALLSTATE_CONNECTED, CALLSTATE_CONNECTED_ACTIVE_HELD) ;
        CPPUNIT_ASSERT(bRC) ;
        bRC = validatorTransferee.waitForCallEvent(0, g_hAutoAnswerCallbackCallOther, CALLSTATE_AUDIO_EVENT, CALLSTATE_AUDIO_STOP) ;
        CPPUNIT_ASSERT(bRC) ;
        bRC = validatorTransferee.waitForCallEvent(0, g_hAutoAnswerCallbackCallOther, CALLSTATE_DISCONNECTED, CALLSTATE_DISCONNECTED_NORMAL) ;
        CPPUNIT_ASSERT(bRC) ;
        bRC = validatorTransferee.waitForCallEvent(0, g_hAutoAnswerCallbackCallOther, CALLSTATE_DESTROYED, CALLSTATE_DESTROYED_NORMAL) ;        
        CPPUNIT_ASSERT(bRC) ;
