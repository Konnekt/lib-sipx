   ...
   : MpDecoderBase(payloadType, &smCodecInfo)
{
    ...
    mLastReportSize=-1;
    osPrintf("MpdSipxPcma::MpdSipxPcma(%d)\n", payloadType);
}
...
int MpdSipxPcma::decode(JB_uchar *encoded, int inSamples, Sample *decoded) 
{
    return G711A_Decoder(inSamples, encoded, decoded);
}
...
void MpdSipxPcma::FrameIncrement(void) 
{
