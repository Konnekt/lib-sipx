...
static GlibAllocator	*current_allocator = NULL;
G_LOCK_DEFINE_STATIC (current_allocator);

/* HOLDS: current_allocator_lock */
static void
g_list_validate_allocator (GlibAllocator *allocator)
{
...
void
g_list_push_allocator(GlibAllocator *allocator)
{
...
_g_list_alloc (void)
{
  ...
  if (!current_allocator)
    {
      GlibAllocator *allocator = g_allocator_new ("GLib default GList allocator",
					       128);
      g_list_validate_allocator (allocator);
      allocator->last = NULL;
      current_allocator = allocator;
